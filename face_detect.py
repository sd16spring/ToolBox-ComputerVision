""" Experiment with face detection and image filtering using OpenCV. This was done through pair programming
with Anne Ku who also added me as a contributor to her pull request. """
...
while(True):
    ...
    ret, frame = cap.read()
    face_cascade = cv2.CascadeClassifier('/home/udesai/ToolBox-ComputerVision/haarcascade_frontalface_alt.xml ')
